...
export class TemplatesPage implements OnInit {
  ...
  ngOnInit() {
    this.temps=[
      {id:1,desc:'Course App',img:'./../../../assets/images/templates/1.png',path:'page8'},
      {id:2,desc:'Course App',img:'./../../../assets/images/templates/2.png',path:'page8'},
      {id:3,desc:'Course App',img:'./../../../assets/images/templates/3.png',path:'page8'},
      {id:4,desc:'Course App',img:'./../../../assets/images/templates/4.png',path:'page8'},
      {id:5,desc:'Course App',img:'./../../../assets/images/templates/5.png',path:'page8'},
      {id:6,desc:'Course App',img:'./../../../assets/images/templates/6.png',path:'page8'},
      {id:7,desc:'Course App',img:'./../../../assets/images/templates/7.png',path:'page8'},
